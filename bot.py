...
# --- التعامل مع أوامر والرسائل في البوت ---
...
# --- التشغيل الرئيسي المصحح والمستقر ---
async def main():
    await start_web_server()
    await bot.start()
    
    # حظر التعليق باستخدام التسمية الصحيحة لمكتبة Hydrogram
    try:
        await bot.delete_webhooks(drop=True)
    except Exception as e:
        logging.warning(f"ملاحظة الـ Webhook: {e}")

    logging.info("🚀 البوت متصل بنجاح ومستعد لاستقبال الرسائل!")
